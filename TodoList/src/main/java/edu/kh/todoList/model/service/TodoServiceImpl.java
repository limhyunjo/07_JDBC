...
// Imple - Service를 구현
  ...
  //DAO 객체 생성
   private TodoDAO dao = null;
	...
	@Override
		public Map<String, Object> selecAll() throws SQLException {
		
		//1.커넥션 얻어오기
		Connection conn = getConnection();
		
		// DAO를 두 번 호출 ( 할 일 목록 조회 + 완료된 할 일 개수 조회 )
	...
	// 위의 할 일 수정 구문 그대로 가져와서 dao 호출 구문만 바꾸기
   Connection conn = getConnection();
